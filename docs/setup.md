...
Follow the instructions in the [Scripts Readme file](../scripts/Readme.md).
...
4. Enter the application id or application name from above in the search box to locate the FHIR Proxy application.
5. Click on the FHIR Proxy application name in the list.
...
14. Congratulations! The selected users have been assigned the access roles and can now perform allowed operations against the FHIR Server.
