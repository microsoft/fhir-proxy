...
This processor is limited to process 5000 resource entries in a search-set bundle. For accurate results, it is imperative that you limit your query so as to not exceed this many resources.
