...
// nameprefix if not currently used, the default naming standards don't support prefixes but may be added in
@description('(not supported) Prefix to be applied to Azure resources')
param namePrefix string = any(null)
...
// verify this code
var identityType = empty(objectId) ? 'SystemAssigned' : 'UserAssigned'
//identityObject not currently used, will be supported in a future version to allow user defined identity for FHIR Proxy
var identityObject = {
  type:identityType
